...
Original file is located at
    https://colab.research.google.com/drive/1fDRE3MplPHgE9wATGbU_OXwmyatjgHtn
"""
...
class CausalMetric():
    ...
    def single_run(self, img_tensor, explanation, verbose=0, save_to=None):
        ...
        for i in range(n_steps+1):
            ...
            scores[i] = pred[0, c]
            """if verbose == 2 or (verbose == 1 and i == int(98*n_steps/1000)):
            ...
            if verbose == 2 or (verbose == 1 and i == int(201*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(304*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(402*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == n_steps/2):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(603*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(705*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(804*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
               ...
               plt.xlabel(ylabel)
               plt.ylabel(get_class_name(c))
            if verbose == 2 or (verbose == 1 and i == int(897*n_steps/1000)):
               plt.figure(figsize=(10, 5))
               plt.subplot(121)
               plt.title('{} {:.1f}%, P={:.4f}'.format(ylabel, 100 * i / n_steps, scores[i]))
               plt.axis('off')
